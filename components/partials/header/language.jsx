...
import flag1 from "@/public/images/all-img/flag-4.png";
import flag2 from "@/public/images/all-img/flag-1.png";
...
const Language 						= () => {
	...
	const handleSelected 				= ( lang ) => {
		setSelectedLanguage( { ...selectedLanguage , name: lang, language: lang === "en" ? "En" : "Bn", } );
		setRtl( lang === "ar" );
